        ...
        <div class="uk-padding uk-container uk-text-center uk-grid uk-align-center uk-width-2-3@s">
            <form class="uk-form-horizontal uk-margin-large" ref={form} onSubmit={sendEmail}>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" name="phone_number" id="form-horizontal-text phone_number" type="text" placeholder="Telefonnummer..." required/>
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    <div class="uk-form-controls">
                        <button type="submit" class="uk-button uk-button-primary">Absenden</button>
                    </div>
                </div>
            <br></br><br></br>
            </form>
